...
public class AbstractAuditableAgitarTest extends AgitarTestCase {
    ...
    public void testGetCreator() throws Throwable {
        AbstractAuditable cvCellCycle = new CvCellCycle( new Institution( "testAbstractAuditableShortLabel" ), "testAbstractAuditableShortLabel" );
    ...
    public void testGetCreator1() throws Throwable {
        String result = new CvCellCycle( new Institution( "testAbstractAuditableShortLabel" ), "testAbstractAuditableShortLabel" ).getCreator();
        assertNull( "result", result );
    }

    public void testGetUpdator() throws Throwable {
        String result = new Institution( "testAbstractAuditableShortLabel" ).getUpdator();
        assertNull( "result", result );
    }

    public void testGetUpdator1() throws Throwable {
        AbstractAuditable institution = new Institution( "testAbstractAuditableShortLabel" );
    ...
    public void testSetCreated() throws Throwable {
        AbstractAuditable cvFuzzyType = new CvFuzzyType( new Institution( "testAbstractAuditableShortLabel" ), "testAbstractAuditableShortLabel" );
